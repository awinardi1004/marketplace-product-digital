...
class ProductOrderController extends Controller
{
    ...
    public function download_file(ProductOrder $productOrder)
    {
        ...
        $paidTransactionExists = ProductOrder::where('buyer_id', $user_id)->where('product_id', $product_id)->where('is_paid', 1)->first();
    ...
    public function update(Request $request, ProductOrder $productOrder)
    {
        ...
        return redirect()->back()->with('message', 'Order succsess updated');
    }
